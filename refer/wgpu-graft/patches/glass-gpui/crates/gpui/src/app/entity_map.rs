...
///
/// Cycles can also happen if an entity owns a task or subscription that itself
/// owns a strong reference to the entity again.
///
/// # Usage
///
...
impl fmt::Debug for BacktraceFormatter {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let mut formatter = BacktraceFmt::new(fmt, style, &mut print_path);
        formatter.add_context()?;
        let mut strip = true;
